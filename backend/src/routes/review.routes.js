...
// Get reviews for a specific location with pagination (RAW reviews, not analyzed)
router.get(
  "/location/:locationId",
  authenticate,
  reviewController.getLocationReviews,
);
...
router.get(
  "/:locationId/sentiment/:sentiment",
  reviewController.getReviewsBySentiment,
);
