    ...
    <header className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm z-50 shadow-[1px_2px_40px_rgba(0,0,0,0.15)]">
      <div className="relative max-w-full mx-auto px-4 sm:px-6 lg:px-12 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 z-10">
          ...
          />
          <span
            className="text-lg sm:text-xl text-emerald-900 font-semibold"
            style={{ fontFamily: 'var(--font-mate)' }}
          >
            SentiLoka
          </span>
        </div>
        ...
        <nav className="hidden lg:flex items-center gap-8 xl:gap-10 absolute left-1/2 transform -translate-x-1/2">
          <button 
            ...
            className="text-gray-800 hover:text-emerald-700 transition-colors text-base font-medium whitespace-nowrap"
          >
            Features
          </button>
          <button 
        ...
        <div className="hidden lg:block">
          ...
          >
            <span
              className="absolute inset-0 bg-[#4B7068] opacity-0 group-hover:opacity-100 transition-opacity duration-500"
            ></span>
